...
//---------------------------------------------------- Fitting Algorithms ----------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------------
//These routines perform simple (somewhat constrained) fitting to a function.
//
//They are around primarily because they are easy to tweak (compared with black boxes) and for speed (compared with highly-
// flexible, but currently slow-as-hell PolyCAS routines).
//
