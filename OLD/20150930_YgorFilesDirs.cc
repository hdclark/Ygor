...
//#include "YgorTime.h"    //Needed for Last_Access_Time(), Last_Modification_Time().

#include "YgorFilesDirs.h"

#ifndef YGORFILESDIRS_INCLUDE_ALL_SPECIALIZATIONS
...
#ifdef YGORFILESDIRS_INCLUDE_ALL_SPECIALIZATIONS
/*
