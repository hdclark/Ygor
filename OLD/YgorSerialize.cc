...
//
//NOTE: There appears to be a highly template-able theme to this code. I think
// I can construct arbitrarily-nested routines seamlessly using template
// overrides. Right now, I am overriding the 
...
#ifndef YGORSERIALIZE_INCLUDE_ALL_SPECIALIZATIONS
...
SERIALIZE::Put_Intrinsic(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, T val){
    //Parameters:
...
#ifdef YGORSERIALIZE_INCLUDE_ALL_SPECIALIZATIONS
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint8_t);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint16_t);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint32_t);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint64_t);

    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int8_t);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int16_t);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int32_t);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int64_t);

    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, char);

    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, float);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, double);
#endif
namespace SERIALIZE {
    template <> std::unique_ptr<uint8_t[]>
    Put_Intrinsic(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, std::string val){
        return SERIALIZE::Put_String<char>(OK,std::move(in),offset,max,val);
    }
}
...
template <class T> std::unique_ptr<uint8_t[]> 
SERIALIZE::Get_Intrinsic(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, T *val){
    //Parameters:
    //  - OK     - Indicates success or failure. Do not use output if false.
    //  - in     - The block of memory holding the serialized data.
    //  - offset - The offset from in[0] in sizeof(uint8_t) = 1 = BYTES indicating the data. Will be incremented after read.
...
#ifdef YGORSERIALIZE_INCLUDE_ALL_SPECIALIZATIONS
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint8_t *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint16_t *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint32_t *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, uint64_t *);
    
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int8_t *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int16_t *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int32_t *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, int64_t *);
   
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, char *);
 
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, float *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, double *);
#endif
namespace SERIALIZE {
    template <> std::unique_ptr<uint8_t[]>
    Get_Intrinsic(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, std::string *val){
        return SERIALIZE::Get_String<char>(OK,std::move(in),offset,max,val);
    }
}
...
SERIALIZE::Put_Size(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, uint64_t val){
    ...
    //Try writing the size into a single byte.
    {
      ...
      in = SERIALIZE::Put_Intrinsic<uint8_t>(&l_OK,std::move(in),offset,max,shtl);
      if(l_OK == false){
    ...
    //And then with two bytes.
    {
      ...
      in = SERIALIZE::Put_Intrinsic<uint16_t>(&l_OK,std::move(in),offset,max,shtl);
      if(l_OK == false){
    ...
    //And then with 8 bytes, because size is probably not an issue.
    {
      ...
      in = SERIALIZE::Put_Intrinsic<uint64_t>(&l_OK,std::move(in),offset,max,shtl);
      if(l_OK == false){
...
SERIALIZE::Get_Size(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, uint64_t *val){
    ...
    //Try reading the size into a single byte.
    {
      ...
      in = SERIALIZE::Get_Intrinsic<uint8_t>(&l_OK,std::move(in),offset,max,&shtl);
      if(l_OK == false){
      ...
      if(shtl != std::numeric_limits<uint8_t>::max()){ //Success.
          // *offset += sizeof(T); //Get_Intrinsic() has already advanced the offset.
    ...
    //Try again with two bytes.
    {
      ...
      in = SERIALIZE::Get_Intrinsic<uint16_t>(&l_OK,std::move(in),offset,max,&shtl);
      if(l_OK == false){
    ...
    //Try again with eight bytes. Storage cost clearly doesn't matter anymore...
    {
      ...
      in = SERIALIZE::Get_Intrinsic<uint64_t>(&l_OK,std::move(in),offset,max,&shtl);
      if(l_OK == false){
...
template <class T> std::unique_ptr<uint8_t[]> 
SERIALIZE::Get_Intrinsic_Sequence_Container(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, T *val){
    if(OK != nullptr) *OK = false;
    if(in == nullptr){
        return FailWarn_or_Die(OK, std::move(in), "Passed nullptr when data was expected. Indicating failure and continuing",
                                                  "Passed nullptr when data was expected. Unable to continue");
    ...
    for(uint64_t i = 0; i < str_size; i+=sizeof(shtl)){
        in = SERIALIZE::Get_Intrinsic<typename T::value_type>(&l_OK, std::move(in), offset, max, &shtl);
        if(l_OK == false){
    ...
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, std::list<uint8_t> *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, std::list<double> *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, std::list<std::string> *);

    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, std::vector<uint8_t> *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, std::vector<double> *);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Get_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, std::vector<std::string> *);
#endif


template <class T> std::unique_ptr<uint8_t[]> 
SERIALIZE::Put_Intrinsic_Sequence_Container(bool *OK, std::unique_ptr<uint8_t[]> in, uint64_t *offset, uint64_t max, const T &val){
    if(OK != nullptr) *OK = false;
    if(in == nullptr){
        return FailWarn_or_Die(OK, std::move(in), "Passed nullptr when data was expected. Indicating failure and continuing",
                                                  "Passed nullptr when data was expected. Unable to continue");
    ...
    for(auto it = val.begin(); it != val.end(); ++it){
        in = SERIALIZE::Put_Intrinsic<typename T::value_type>(&l_OK, std::move(in), offset, max, *it);
        if(l_OK == false){
...
#ifdef YGORSERIALIZE_INCLUDE_ALL_SPECIALIZATIONS
    //Fill this in with anything which is needed.
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, const std::list<uint8_t> &);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, const std::list<double> &);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, const std::list<std::string> &);
    
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, const std::vector<uint8_t> &);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, const std::vector<double> &);
    template std::unique_ptr<uint8_t[]> SERIALIZE::Put_Intrinsic_Sequence_Container(bool *, std::unique_ptr<uint8_t[]>, uint64_t *, uint64_t, const std::vector<std::string> &);
#endif
