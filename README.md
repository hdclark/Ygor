...
[![SLOC](https://img.shields.io/badge/LOC-60k-green.svg)](https://gitlab.com/hdeanclark/Ygor)
...
(2010-present) to house bits of code that are convenient for multiple projects.
...
2010-present Hal Clark. See [LICENSE.txt](LICENSE.txt) for details about the
