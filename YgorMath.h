...
//        void append(const vec3<T> &point);
        ...
        contour_of_points<T> Resample_Evenly_Along_Perimeter(const long int N) const; //Walks along the perimeter, creating a new point (using interpolation) every [perimeter]/N .
