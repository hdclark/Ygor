...
Create explicit vertices, halfedges, patches, seam sectors, and optionally volumetric cell adjacency. The representation may be non-manifold as an overlay of two valid boundaries, but its sector structure must be complete enough to recover manifold selected results.
