...
#ifndef YGOR_MATH_MONOTONE_DECOMPOSITION_DISABLE_ALL_SPECIALIZATIONS
    template std::vector<vec2<float >>
        Materialize_Polygon<float , uint32_t>(const std::vector<std::vector<vec2<float >>> &, const monotone_t<uint32_t> &);
    template std::vector<vec2<float >>
        Materialize_Polygon<float , uint64_t>(const std::vector<std::vector<vec2<float >>> &, const monotone_t<uint64_t> &);

    template std::vector<vec2<double>>
        Materialize_Polygon<double, uint32_t>(const std::vector<std::vector<vec2<double>>> &, const monotone_t<uint32_t> &);
    template std::vector<vec2<double>>
        Materialize_Polygon<double, uint64_t>(const std::vector<std::vector<vec2<double>>> &, const monotone_t<uint64_t> &);
#endif
...
Triangulate_Monotone_Decomposition(const std::vector<std::vector<vec2<T>>> &verts,
    ...
    template fv_surface_mesh<float , uint32_t>
        Triangulate_Monotone_Decomposition(const std::vector<std::vector<vec2<float >>> &,
                                           const std::vector<monotone_t<uint32_t>> &, bool);
