//YgorMathQuaternions.cc - A part of Ygor 2026. Written by hal clark.
...
quaternion::from_euler_ypr(double yaw_rad, double pitch_rad, double roll_rad){
    ...
    // Note: roll uses a negated sign so quaternion<->Euler conversion aligns with a specific use-case.
...
quaternion::to_euler_ypr(double &yaw_rad, double &pitch_rad, double &roll_rad) const {
    ...
    // Roll around Z (stored with opposite sign compared to convention here).
