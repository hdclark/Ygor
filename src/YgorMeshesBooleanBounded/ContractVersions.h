...
struct contract_versions final {
    ...
    static constexpr std::uint16_t exact_expansion_adapter = 3;
    ...
    static constexpr std::uint16_t predicate_truth_layers = 2;
    static constexpr std::uint16_t construction_conditioning = 2;
    ...
    static constexpr std::uint16_t precision_codec = 3;
    static constexpr std::uint16_t precision_verifier = 2;
    ...
    static constexpr std::uint16_t relation_artifact_schema = 19;
    ...
    static constexpr std::uint16_t relation_execution_authority_schema = 2;
    static constexpr std::uint16_t relation_triangle_local_publication_schema = 1;
    static constexpr std::uint16_t relation_family_precedence_policy = 1;
    static constexpr std::uint16_t relation_truth_policy = 3;
    ...
    static constexpr std::uint16_t relation_interval_evidence_schema = 3;
    static constexpr std::uint16_t relation_source_facet_region_publication_schema = 2;
    ...
    static constexpr std::uint16_t relation_source_edge_facet_schema = 2;
    static constexpr std::uint16_t relation_source_edge_facet_policy = 1;
    static constexpr std::uint16_t relation_source_edge_facet_stage_schema = 3;
    ...
    static constexpr std::uint16_t relation_source_facet_facet_schema = 2;
    static constexpr std::uint16_t relation_source_facet_facet_policy = 1;
    static constexpr std::uint16_t relation_source_facet_facet_stage_schema = 2;
    static constexpr std::uint16_t relation_source_facet_facet_stage_policy = 1;
    static constexpr std::uint16_t relation_coplanar_overlay_schema = 4;
    ...
    static constexpr std::uint16_t relation_coplanar_topology_schema = 2;
    static constexpr std::uint16_t relation_coplanar_topology_policy = 2;
    ...
    static constexpr std::uint16_t relation_construction_schema = 4;
    static constexpr std::uint16_t relation_construction_registry_policy = 1;
    static constexpr std::uint16_t relation_construction_ledger_schema = 3;
    ...
    static constexpr std::uint16_t relation_codec = 21;
    static constexpr std::uint16_t relation_verifier = 21;
    ...
    // Component 15 independent final verification and replay diagnostics.
    static constexpr std::uint16_t final_verification_artifact_schema = 1;
    static constexpr std::uint16_t final_verification_provider = 1;
    ...
    // Component 16 test infrastructure and release qualification.
    static constexpr std::uint16_t qualification_artifact_schema = 1;
    static constexpr std::uint16_t qualification_provider = 1;
    static constexpr std::uint16_t qualification_codec = 1;
    static constexpr std::uint16_t qualification_verifier = 1;
