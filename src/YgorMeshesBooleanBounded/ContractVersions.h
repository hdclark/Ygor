...
struct contract_versions final {
    ...
    static constexpr std::uint16_t relation_artifact_schema = 4;
    ...
    static constexpr std::uint16_t relation_codec = 4;
    static constexpr std::uint16_t relation_verifier = 4;
