...
constexpr std::uint16_t selected_exact_boundary_schema = 2;
...
struct selected_halfedge { selected_halfedge_id id; selected_patch_id patch; selected_cycle_id cycle; selected_edge_id edge; selected_vertex_id origin, destination; selected_halfedge_id next, previous; };
...
struct boolean_selection_certificate {
  ...
  std::uint64_t decisions = 0, discard_exterior = 0, discard_internal = 0,
                ...
                selected_vertices = 0, provenance_uses = 0,
