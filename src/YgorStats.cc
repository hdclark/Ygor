...
template <class T>
Stats::RandomForest<T>::RandomForest(int64_t n_trees,
                                     int64_t max_depth,
...
#ifndef YGORSTATS_DISABLE_ALL_SPECIALIZATIONS
    template Stats::RandomForest<double>::RandomForest(int64_t, int64_t, int64_t, int64_t, uint64_t);
    template Stats::RandomForest<float>::RandomForest(int64_t, int64_t, int64_t, int64_t, uint64_t);
#endif


template <class T>
void Stats::RandomForest<T>::fit(const num_array<T> &X, const num_array<T> &y) {
...
#ifndef YGORSTATS_DISABLE_ALL_SPECIALIZATIONS
    template void Stats::RandomForest<double>::fit(const num_array<double> &, const num_array<double> &);
    template void Stats::RandomForest<float>::fit(const num_array<float> &, const num_array<float> &);
#endif


template <class T>
std::unique_ptr<typename Stats::RandomForest<T>::TreeNode>
Stats::RandomForest<T>::build_tree(
    const num_array<T> &X,
    const num_array<T> &y,
...
template <class T>
bool Stats::RandomForest<T>::find_best_split(
    const num_array<T> &X,
    const num_array<T> &y,
    const std::vector<int64_t> &sample_indices,
    int64_t &best_feature,
...
template <class T>
T Stats::RandomForest<T>::compute_variance_reduction(
    const num_array<T> &y,
...
#ifndef YGORSTATS_DISABLE_ALL_SPECIALIZATIONS
    template double Stats::RandomForest<double>::compute_variance_reduction(const num_array<double> &,
                                                                           const std::vector<int64_t> &,
                                                                           const std::vector<int64_t> &);
    template float Stats::RandomForest<float>::compute_variance_reduction(const num_array<float> &,
                                                                         const std::vector<int64_t> &,
                                                                         const std::vector<int64_t> &);
#endif
...
template <class T>
T Stats::RandomForest<T>::predict(const num_array<T> &x) const {
    // Validate input.
    if(x.num_rows() != 1){
...
#ifndef YGORSTATS_DISABLE_ALL_SPECIALIZATIONS
    template double Stats::RandomForest<double>::predict(const num_array<double> &) const;
    template float Stats::RandomForest<float>::predict(const num_array<float> &) const;
#endif


template <class T>
T Stats::RandomForest<T>::predict_tree(const TreeNode *node, const num_array<T> &x) const {
    if(node->is_leaf){
        return node->value;
    }
...
#ifndef YGORSTATS_DISABLE_ALL_SPECIALIZATIONS
    template double Stats::RandomForest<double>::predict_tree(const TreeNode *, const num_array<double> &) const;
    template float Stats::RandomForest<float>::predict_tree(const TreeNode *, const num_array<float> &) const;
#endif


template <class T>
int64_t Stats::RandomForest<T>::get_n_trees() const {
    return this->n_trees;
}
#ifndef YGORSTATS_DISABLE_ALL_SPECIALIZATIONS
    template int64_t Stats::RandomForest<double>::get_n_trees() const;
    template int64_t Stats::RandomForest<float>::get_n_trees() const;
#endif
