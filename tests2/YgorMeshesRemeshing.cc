...
TEST_CASE("mesh_remesher completes reasonably quickly (subjective) on a refined mesh"){

    SUBCASE("remeshing a refined icosahedron completes reasonably promptly"){
