...
- [ ] Component 7: relation kernel and frozen symbolic perturbation matrix. Foundation, canonical edge/edge, edge/facet, facet/facet and coplanar topology, final artifact/codec/decode publication, globally identified coplanar tables, transactional accounting, source-fan crossing conservation, evidence-driven symbolic eligibility, canonical imported/bounded/exact truth lineage, first-class family-04 parameter/residual/conditioning/region evidence, canonical clustered edge/facet event order, and the authoritative cross-family construction registry with compatibility ledger and independent reconstruction are implemented; remaining symbolic/replay obligations and complete qualification are tracked in `component_07_implementation_status.md`.
