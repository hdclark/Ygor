...
- [ ] Component 7: relation kernel and frozen symbolic perturbation matrix. Foundation, primitive truth and source-facet slices, canonical source-edge/source-edge relations, source-edge/source-facet numerical/candidate composites, source-facet/source-facet support, complete candidate-derived facet-boundary closure, transaction-local coplanar classification, certified one-per-original-edge boundary partitions, and canonical lineage-keyed coplanar event nodes/oriented arcs/overlap components with distinct sheet occurrences, complete interval coverage, owner-free semantics, and independent reconstruction are implemented; fan/multiplicity/symbolic integration, final artifact/codec/replay publication, and remaining qualification obligations are tracked in `component_07_implementation_status.md`.
