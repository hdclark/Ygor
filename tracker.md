...
- [ ] Component 7: relation kernel and frozen symbolic perturbation matrix. Foundation, canonical edge/edge, edge/facet, facet/facet and coplanar topology, final artifact/codec/decode publication, globally identified coplanar tables, transactional accounting, source-fan crossing conservation, evidence-driven symbolic eligibility, canonical imported/bounded/exact truth lineage, and first-class family-04 parameter/residual/conditioning/region evidence with independent reconstruction are implemented; clustered multi-event ties, remaining construction deduplication/ledger evidence, symbolic/replay obligations, and complete qualification are tracked in `component_07_implementation_status.md`.
