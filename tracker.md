...
- [ ] Component 7: relation kernel and frozen symbolic perturbation matrix. Foundation, primitive truth and source-facet slices, canonical edge/edge, edge/facet, facet/facet, complete coplanar boundary closure and lineage-keyed topology, canonical final artifact/codec/decode publication, candidate-scaled transactional resource accounting, topology-authoritative source-fan crossing conservation, and evidence-driven symbolic eligibility with independent reconstruction are implemented; unified primitive-support publication, clustered multi-event ties, first-class coplanar topology sections, full construction evidence/deduplication, remaining symbolic/replay obligations, and complete qualification are tracked in `component_07_implementation_status.md`.
