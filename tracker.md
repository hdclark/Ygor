...
- [ ] Component 7: relation kernel and frozen symbolic perturbation matrix. Foundation, primitive truth and source-facet slices, canonical source-edge/source-edge relations, source-edge/source-facet numerical/candidate composites, source-facet/source-facet support, complete candidate-derived facet-boundary closure, and transaction-local coplanar contact/overlap/containment/equality classification with distinct occurrences, owner-free semantics, and independent reconstruction are implemented; canonical overlay-component/oriented-arc assembly, fan/multiplicity/symbolic integration, final artifact/codec/replay publication, and remaining qualification obligations are tracked in `component_07_implementation_status.md`.
