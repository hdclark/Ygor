...
- [ ] Component 7: relation kernel and frozen symbolic perturbation matrix. Foundation, primitive truth and source-facet slices, canonical edge/edge, edge/facet, facet/facet, complete coplanar boundary closure and lineage-keyed topology, canonical final artifact/codec/decode publication, first-class globally identified coplanar node/arc/component tables, candidate-scaled transactional resource accounting, topology-authoritative source-fan crossing conservation, evidence-driven symbolic eligibility, and canonical imported/bounded/exact truth-lineage producers with independent reconstruction are implemented; complete interval/region primitive publication, clustered multi-event ties, full construction evidence/deduplication, remaining symbolic/replay obligations, and complete qualification are tracked in `component_07_implementation_status.md`.
